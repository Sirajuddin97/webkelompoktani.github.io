...
<head>
  ...
  <title>Petani - Laporan Penggunaan Dana</title>
                    ...
                    <div class="px-3">
                      <form class="form" action="config/simpan.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <div class="position-relative">
                            <input class="form-control" name="foto[]" type="file" required style=" padding: 2px; ">
                          </div>
                        </div>
                        <div class="form-group">
                          <label>Upload Bukti Fisik</label>
                          <div class="position-relative">
                            <input class="form-control" name="foto[]" type="file" required style=" padding: 2px; ">
                          </div>
                        </div>
                        ...
                        <div class="form-actions right">
                          <button type="submit" class="btn btn-teal" <?php echo $view_btn; ?>>
