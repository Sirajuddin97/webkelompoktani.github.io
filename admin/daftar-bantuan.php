...
<head>
  ...
  <title>Admin - Daftar Bantuan Petani</title>
                ...
                <div class="card">
                  <div class="card-header">
                    <div class="card-title-wrap bar-teal">
                      <h4 class="card-title" id="basic-layout-icons">Daftar Penerima Bantuan Petani</h4>
                    </div>
                  </div>
                  <div class="card-body">
                    <div class="px-3">
                        ...
                        <div class="">
                          <div class="table-responsive">
                            <table id="example" class="table table-striped table-bordered zero-configuration dataTable"
                              ...
                              //
                              $no            = 0;
                              $query         = "SELECT * FROM tbl_bantuan ORDER BY id_bantuan DESC"; 
                              $sql           = mysqli_query($connection, $query); 
                              while($data    = mysqli_fetch_array($sql)){ 
                              $no++;
                                //
                                $query2      = "SELECT * FROM tbl_petani WHERE id_petani='".$data['id_petani']."'"; 
                              ...
                              echo "<tr>
                                  <td>$no</td>
                                  <td>".$data2['nik']."</td>
                                  <td>".$data2['nama_petani']."</td>
                                  <td>".$data['tahun']."</td>
                                  <td>".$data['periode_bantuan']."</td>
                              ...
                              echo '
                                  ...
                                  <a href="config/hapus.php?id_bantuan='.$data["id_bantuan"].'" data-toggle="tooltip" data-placement="top" title="Hapus Data"
                                   class="btn btn-danger btn-fab btn-sm" onclick="return confirm(\'Yakin ingin menghapus '.$data["nama"].'?\');"> <i class="icon-trash"></i> Hapus</a>
