...
<head>
  ...
  <title>Petani - Daftar Data Kondisi Keuangan</title>
                ...
                <div class="card">
                  <div class="card-header">
                    <div class="card-title-wrap bar-teal">
                      <h4 class="card-title" id="basic-layout-icons">Daftar Data Kondisi Keuangan</h4>
                    </div>
                  </div>
                  <div class="card-body">
                    <div class="px-3">
                        ...
                        <div class="">
                          <div class="table-responsive">
                            <table id="example" class="table table-striped table-bordered zero-configuration dataTable"
                              ...
                              //
                              $no            = 0;
                              $query         = "SELECT * FROM tbl_keuangan WHERE id_users='".$data2['id_users']."' order by id_keuangan desc"; 
                              ...
                              echo '
                                  ...
                                  <a href="edit-keuangan.php?id_keuangan='.$data["id_keuangan"].'" data-toggle="tooltip" data-placement="top" title="Edit Data"
                                   class="btn btn-info btn-fab btn-sm"> <i class="icon-note"></i></a>

                                  <a href="config/hapus.php?id_keuangan='.$data["id_keuangan"].'" data-toggle="tooltip" data-placement="top" title="Hapus Data"
