...
<head>
  ...
  <title>Admin - Tambah Data Hasil Produksi</title>
                      ...
                      <form class="form" action="config/simpan.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <div class="position-relative">
                            <input type="text" class="form-control" placeholder="Contoh: Jagung" name="nama_produksi" id="text-only" placeholder=""
                              required>
                          </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <label>Target Minimum Hasil Produksi</label>
