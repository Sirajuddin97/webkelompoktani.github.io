...
<head>
  ...
  <title>Petani - Daftar Data Hasil Produksi</title>
                ...
                <div class="card">
                  <div class="card-header">
                    <div class="card-title-wrap bar-teal">
                      <h4 class="card-title" id="basic-layout-icons">Daftar Data Hasil Produksi</h4>
                    </div>
                  </div>
                  <div class="card-body">
                    <div class="px-3">
                          ...
                          <div class="table-responsive">
                            <table id="example" class="table table-striped table-bordered zero-configuration dataTable"
                              ...
                              <thead>
                                <tr>
                                  <th width="5%">No</th>
                                  <th width="15%">Tahun Produksi</th>
                                  <th width="15%">Periode Panen</th>
                                  <th>Hasil Produksi (KG)</th>
                                  <th>Target Minimum Hasil Produksi (KG)</th>
                                  <th>Pilihan</th>
                                </tr>
                              </thead>
                              <tbody>
                              ...
                              //
                              $no            = 0;
                              $query         = "SELECT * FROM tbl_hasilproduksi WHERE id_users='".$data2['id_users']."' order by id_hasil desc"; 
                              ...
                              echo "<tr>
                                  <td>$no</td>
                                  <td>".$data['nama_produksi']."</td>
                                  <td>".$data['periode_panen']."</td>
                                  <td>".$data['hasil']."</td>
                                  <td>".$data['target']."</td>
                                  ";
                              ...
                              echo '
                                  ...
                                  <a href="edit-hasilproduksi.php?id_hasil='.$data["id_hasil"].'" data-toggle="tooltip" data-placement="top" title="Edit Data"
                                   class="btn btn-info btn-fab btn-sm"> <i class="icon-note"></i></a>

                                  <a href="config/hapus.php?id_hasil='.$data["id_hasil"].'" data-toggle="tooltip" data-placement="top" title="Hapus Data"
